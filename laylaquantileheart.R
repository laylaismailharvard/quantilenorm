...
DataLoading <- function(pathdir, sheet) {
  ...
  SampleAnnotationFile <- list.files(file.path(pathdir, "annotationheart"), 
...
#save quantile normalized data for heart
write.csv(ramdat, "heart.quantilenorm.data.csv", row.names = TRUE)
